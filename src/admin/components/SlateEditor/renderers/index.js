...
export const ImageElement = ({ attributes, children, element }) => {
  ...
  console.log("I am adding an image element in here", element);
...
export const ContentWrapperWithRemove = ({ attributes, element, children }) => {
  ...
  return (
    <div {...attributes} className="slate-editor-content-wrapper">
      <div
        style={{ display: selected && focused ? "block" : "none" }}
        className="slate-editor-content-toolbar"
      >
...
export const Element = ({
  ...
  switch (element.type) {
    case "block-quote":
      return (
        <blockquote style={inlineStyles} {...attributes}>
          {children}
        </blockquote>
      );
    case "bulleted-list":
      return (
        <ul style={inlineStyles} {...attributes}>
          {children}
        </ul>
      );
    case "heading-one":
      return (
        <h1 style={inlineStyles} {...attributes}>
          {children}
        </h1>
      );
    case "heading-two":
      return (
        <h2 style={inlineStyles} {...attributes}>
          {children}
        </h2>
      );
    case "heading-three":
      return (
        <h3 style={inlineStyles} {...attributes}>
          {children}
        </h3>
      );
    case "heading-four":
      return (
        <h4 style={inlineStyles} {...attributes}>
          {children}
        </h4>
      );
    case "heading-five":
      return (
        <h5 style={inlineStyles} {...attributes}>
          {children}
        </h5>
      );
    case "heading-six":
      return (
        <h6 style={inlineStyles} {...attributes}>
          {children}
        </h6>
      );
    case "list-item":
      return (
        <li style={inlineStyles} {...attributes}>
          {children}
        </li>
      );
    case "numbered-list":
      return (
        <ol style={inlineStyles} {...attributes}>
          {children}
        </ol>
      );
    case "image":
    ...
    default:
      return (
        <p style={inlineStyles} {...attributes}>
          {children}
        </p>
      );
  }
