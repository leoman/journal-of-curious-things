...
const App = () => (
  <Provider store={store}>
    <AppWrapper>
      <Router>
        <Switch>
          <Route path="/admin/posts/preview/:slug" exact component={PostView} />
          ...
          <Route path="/admin/products/preview/:slug" exact component={ProductView} />
          ...
          <Route path="/admin/gallery" exact component={AdminGalleryList} />
